...
// 고등학교 세부 유형 키워드 (검색어 파싱용)
const HS_TYPES = ['특성화고', '마이스터고', '일반고', '자율고', '특목고', '외국어고', '과학고']
  ...
  const doSearch = useCallback(async (q) => {
    ...
    try {
      ...
      try {
        ...
        // 유형 키워드가 있으면 HS_SC_NM 으로 필터
        if (hsType) neisResults = neisResults.filter(s => s.hsType === hsType)
      } catch {
        // API 실패 무시
      }
